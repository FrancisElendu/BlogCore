...
{
    public class TagRepository : SqlRepository<Tag>, ITagRepository
    {
        ...
        public async Task<IReadOnlyList<Tag>> FindAsync(ISpecification<Tag> specification, CancellationToken cancellationToken = default)
        {
